...
app.service('requestsService', function () {
    ...
    this.insertRequest = function (firstName, lastName, city) {
    ...
    this.updateRequest = function (firstName, lastName, city) {
        for (var i = 0; i < requests.length; i++) {
            if (requests[i].id === id) {
                requests[i]['firstName'] = firstName;
                requests[i]['lastName'] = lastName;
                requests[i]['city'] = city;
                return;
            }
        }
    };
